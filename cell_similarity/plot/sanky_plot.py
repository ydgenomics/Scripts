...
parser.add_argument('--path', type=str, default="/data/work/cotton/output/Similarity/cotton_metaNeighbor.csv", help='Path to the metaNeighbor CSV file')
parser.add_argument('--seq', type=str, default="/data/work/cotton/output/Similarity/seq.txt", help='Path to the sequence file')
