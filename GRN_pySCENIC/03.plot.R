# ==============================================================================
# plot in R https://mp.weixin.qq.com/s/9n1ITFcC3fT8uyQGlL3Qtw
# ==============================================================================
library(Seurat)
library(SCopeLoomR) 
library(AUCell)
...
setwd("/data/work/tomato/3.pySCENIC")
# load data
...
#############plot
setwd("/data/work/tomato/3.pySCENIC/output")
